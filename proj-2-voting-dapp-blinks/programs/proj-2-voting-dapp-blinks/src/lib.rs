...
//         ctx.accounts: This accesses the accounts struct that you defined in your InitializePoll struct
//  ctx.accounts.poll: This specifically accesses the poll account from your accounts struct
